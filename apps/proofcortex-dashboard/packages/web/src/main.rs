/*
use dioxus::prelude::*;
use dioxus_router::{Router, Link, Routable, Outlet};  // Specific imports — no glob to avoid ambiguity
    ...
    rsx! {
        div { class: "min-h-screen bg-gray-50 flex flex-col lg:flex-row",
            ...
            header { class: "lg:hidden bg-gradient-to-r from-indigo-950 to-purple-950 text-white p-4 flex justify-between items-center shadow-lg",
                ...
                img { src: "/assets/ProofCortex.png", alt: "ProofCortex", class: "h-12" }
                div { class: "w-7 h-7 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold", "VV" }
            }
            ...
            div { class: "flex-1 flex flex-col",
                header { class: "hidden lg:flex bg-white border-b px-10 py-6 justify-between items-center shadow-sm",
                    h3 { class: "text-xl font-black bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent", "ProofCortex • Trust Platform for AI" }
                    div { class: "flex items-center gap-6",
                        span { class: "hidden md:block text-gray-600", "veer.vijay@proofcortex.com" }
                        div { class: "w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center text-white text-xl font-bold", "VV" }
                    }
                }
...
fn Overview() -> Element {
    rsx! {
        div { class: "max-w-7xl mx-auto",
            h2 { class: "text-2xl font-black text-gray-900 mb-6", "Dashboard Overview" }
            p { class: "text-md text-gray-600 mb-12", "Real-time monitoring of AI model trust and proof integrity" }
                ...
                div { class: "bg-white rounded-3xl shadow-2xl p-10 border border-indigo-100 hover:shadow-3xl transition",
                    div { class: "flex justify-between items-start",
                        div {
                            ...
                            p { class: "text-3xl font-black text-indigo-600", "12" }
                        }
                ...
                div { class: "bg-white rounded-3xl shadow-2xl p-10 border border-indigo-100 hover:shadow-3xl transition",
                    div { class: "flex justify-between items-start",
                        div {
                            ...
                            p { class: "text-3xl font-black text-emerald-600", "184" }
                        }
                        Icon { icon: LdLayoutDashboard , class: "w-14 h-14 text-indigo-500 opacity-20" } 
                    }
                }
                div { class: "bg-white rounded-3xl shadow-2xl p-10 border border-indigo-100 hover:shadow-3xl transition",
                    div { class: "flex justify-between items-start",
                        div {
                            ...
                            p { class: "text-3xl font-black text-teal-600", "96.8%" }
                        }
...
fn Models() -> Element {
    rsx! {
        div { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 lg:pt-12",
            h2 { class: "text-2xl font-black text-gray-900", "Registered Models" }
            p { class: "mt-4 text-xl text-gray-600", "All AI models onboarded to ProofCortex with immutable proof trails" }

            button { class: "mt-8 inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-xl font-bold rounded-3xl shadow-2xl hover:shadow-purple-600/50 transform hover:scale-105 transition",
                ...
                div { class: "bg-white rounded-3xl shadow-2xl border border-indigo-100 hover:shadow-3xl transition",
                    div { class: "p-10",
                        div { class: "flex items-center gap-5 mb-6",
                            div { class: "w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex-center text-white text-xl font-black shadow-lg", "LLM" }
                            div {
                                h3 { class: "text-xl font-black text-gray-900", "LLM Assistant Enterprise" }
